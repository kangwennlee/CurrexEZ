...
public class SellRinggit extends AppCompatActivity implements accNumEnterDialog.dialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_ringgit);
        //
    ...
    private void initialize() {
        ...
        editTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog mDatePicker = new DatePickerDialog(SellRinggit.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
    ...
    protected void onResume() {
        super.onResume();
        mFirebaseAnalytics.logEvent("foreign_click_sell", null);
    }
    ...
    public void updatePrice(int position) {
        ...
        textViewTotal.setText("You will get: " + currencyName[position] + " " + String.format(Locale.US, "%.2f", total));
    }
